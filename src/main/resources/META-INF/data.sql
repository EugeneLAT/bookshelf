...
insert into books(id, title, author, isbn, year) values (-1, 'Title 1','Prototype Test1','113456', 1990)
insert into books(id, title, author, isbn, year) values (-2, 'Title 2','Prototype Test2','122456', 1991)
insert into books(id, title, author, isbn, year) values (-3, 'Title 3','Prototype Test3','123356', 1992)
insert into books(id, title, author, isbn, year) values (-4, 'Title 4','Prototype Test4','123446', 1993)